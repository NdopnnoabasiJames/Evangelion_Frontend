          ...
          <div className="card border-0 shadow-sm bg-warning-gradient text-white h-100">
            <div className="card-body">
              <div className="d-flex align-items-center">                <div className="flex-shrink-0">
                ...
                <div className="flex-grow-1 ms-3">
                  <h6 className="text-white-50 mb-1">Total Services/Programs</h6>
                ...
                <div className="col-md-6">
                  <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                    <div>
                      ...
                      <h4 className="mb-0 text-success text-center text-md-start">{approvedBranchAdmins.length}</h4>
                    </div>
                ...
                <div className="col-md-6">
                  <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                    <div>
                      ...
                      <h4 className="mb-0 text-warning text-center text-md-start">{pendingBranchAdmins.length}</h4>
                    </div>

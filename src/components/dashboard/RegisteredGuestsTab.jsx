...
const RegisteredGuestsTab = ({ registeredGuests, loading, error, setShowGuestModal }) => (
  <div>
        ...
        <div className="card-body p-0">
          <div className="table-responsive">
            <table className="table table-hover mb-0">
              <thead className="table-light"><tr><th scope="col">Guest Name</th><th scope="col">Contact</th><th scope="col">Event</th><th scope="col">Comments</th><th scope="col">Event Date & Time</th><th scope="col">Status</th><th scope="col">Registered</th></tr></thead>

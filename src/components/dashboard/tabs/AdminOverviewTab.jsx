                ...
                <div className="col-md-6">
                  <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                    <div>
                      ...
                      <h4 className="mb-0 text-primary text-center text-md-start">{dashboardData?.adminsByRole?.stateAdmins || 0}</h4>
                    </div>
                ...
                <div className="col-md-6">
                  <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                    <div>
                      ...
                      <h4 className="mb-0 text-success text-center text-md-start">{dashboardData?.adminsByRole?.branchAdmins || 0}</h4>
                    </div>
                ...
                <div className="col-md-6">
                  <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                    <div>
                      ...
                      <h4 className="mb-0 text-info text-center text-md-start">{dashboardData?.adminsByRole?.zonalAdmins || 0}</h4>
                    </div>
                ...
                <div className="col-md-6">
                  <div className="d-flex justify-content-between align-items-center p-3 bg-light rounded">
                    <div>
                      ...
                      <h4 className="mb-0 text-secondary text-center text-md-start">{dashboardData?.adminsByRole?.workers || 0}</h4>
                    </div>

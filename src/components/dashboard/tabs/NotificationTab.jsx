...
const NotificationTab = ({ isReadOnly = false }) => {
  ...
  const [selectedNotificationForModal, setSelectedNotificationForModal] = useState(null);
                      ...
                      {notification.message?.length > 100 && (
                        <div className="message-actions">
                          <button 
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              toggleMessageExpansion(notification._id);
                            }}
                          >
  ...
  const renderNotificationModal = () => {
    if (!selectedNotificationForModal) return null;

    const notification = selectedNotificationForModal;
          ...
          <div className="modal-body">
            <div className="notification-details-grid">
                ...
                <div className="detail-items">
                  ...
                  {notification.timing && (
                    <div className="detail-item">
                      ...
                      <span><i className="bi bi-stopwatch me-1"></i>{notification.timing}</span>
                    </div>
                  )}
                  
                  <div className="detail-item">
                    <span className="label">Created:</span>
                    <span><i className="bi bi-calendar-plus me-1"></i>{new Date(notification.createdAt).toLocaleString()}</span>
                  </div>
                  
                  {notification.sentAt && (
                    <div className="detail-item">
                      <span className="label">Sent:</span>
                      <span><i className="bi bi-clock me-1"></i>{new Date(notification.sentAt).toLocaleString()}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="detail-section">
                ...
                <div className="detail-items">
                  <div className="detail-item">
                    ...
                    <span><i className="bi bi-calendar-event me-1"></i>{notification.eventId?.name || 'Unknown Event'}</span>
                  </div>
                  {notification.eventId?.date && (
                    <div className="detail-item">
                      <span className="label">Event Date:</span>
                      <span><i className="bi bi-calendar-date me-1"></i>{new Date(notification.eventId.date).toLocaleDateString()}</span>
                    </div>
                  )}
                  {notification.eventId?.location && (
                    <div className="detail-item">
                      <span className="label">Location:</span>
                      <span><i className="bi bi-geo-alt me-1"></i>{notification.eventId.location}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="detail-section">
                ...
                <div className="recipient-stats-detailed">
                  <div className="stat-card">
                    <div className="stat-icon">
                      <i className="bi bi-people"></i>
                    </div>
                    <div className="stat-content">
                      <span className="stat-number">{notification.totalRecipients || 0}</span>
                      <span className="stat-label">Total Recipients</span>
                    </div>
                  </div>
                ...
                <div className="detail-items">
                  {notification.subject && (
                    <div className="detail-item">
                      ...
                      <div className="message-content-modal">{notification.subject}</div>
                    </div>
                  )}

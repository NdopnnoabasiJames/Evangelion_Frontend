...
const PickupStationManagement = () => {
  ...
  const fetchPickupStations = async () => {
    try {
      ...
      const response = await fetchStations(`/api/pickup-stations/by-zone/${zoneId}`);
        ...
        <div className="modal-content">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="modal-footer">
              ...
              <button type="submit" className="btn btn-primary" disabled={loading || !formData.location.trim()}>
                {loading ? (
                  <>
                    <span className="spinner-border spinner-border-sm me-2"></span>
                    Updating...

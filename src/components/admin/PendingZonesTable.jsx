          ...
          {safeZones.length === 0 ? (
            ...
            safeZones.map(zone => (
              <tr key={zone._id}>
                ...
                <td>
                  {zone.zonalAdmins && zone.zonalAdmins.length > 0 ? (
                    <div>
                      {zone.zonalAdmins.map((admin, index) => (
                    ...
                    <span className="text-muted"><i className="bi bi-person-x me-1"></i>No coordinator assigned</span>
                  )}
                </td>
                <td>

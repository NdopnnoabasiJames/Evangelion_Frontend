...
const StatesManagement = ({ isReadOnly = false }) => {  const [states, setStates] = useState([]);
  ...
  const handleViewDetails = (state) => {
    // Use the existing enriched state data from the table
...
// State Details Modal Component
const StateDetailsModal = ({ state, onHide }) => {
            ...
            <div className="row">
                ...
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    ...
                    <div className="mb-3">
                      ...
                      <p className="mb-0">{formatDate(state.createdAt)}</p>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    {state.stateAdmin ? (
                      <>
                        <div className="mb-3">
                          ...
                          <p className="mb-0">{state.stateAdmin.name}</p>
                        </div>
                        <div className="mb-3">
                          <label className="form-label fw-bold">Email</label>
                          <p className="mb-0">{state.stateAdmin.email}</p>
                        </div>
                        {state.stateAdmin.phone && (
                          <div className="mb-3">
                            <label className="form-label fw-bold">Phone</label>
                            <p className="mb-0">{state.stateAdmin.phone}</p>
                          </div>
                        )}
                      </>
                    ) : (
                      <div className="text-center py-3">
                        ...
                        <p className="text-muted mt-2 mb-0">No admin assigned</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              <div className="col-md-6 mb-4">
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    <div className="mb-3">
                      <label className="form-label fw-bold">Current Rank</label>
                      <p className="mb-0">
                        {state.rank ? (
                          <span className="badge bg-primary"># {state.rank}</span>
                        ) : (
                    ...
                    <div className="mb-3">
                      ...
                      <p className="mb-0">
                        <span className="badge bg-success">{state.totalScore || 0} points</span>
                      </p>
                    </div>
                    {state.medal && (
                      <div className="mb-3">
                        <label className="form-label fw-bold">Medal</label>
                        <p className="mb-0">
                          <i className={`bi bi-award-fill me-2 ${
                            state.medal === 'gold' ? 'text-warning' :
                            state.medal === 'silver' ? 'text-secondary' :
                            state.medal === 'bronze' ? 'text-orange' : ''
                          }`}></i>
                          {state.medal.charAt(0).toUpperCase() + state.medal.slice(1)} Medal
                        </p>
                      </div>
                ...
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    <div className="mb-3">
                      ...
                      <p className="mb-0">
                        <span className="badge bg-info">{state.branchCount || 0} branches</span>
                      </p>
                    </div>
                    <div className="mb-3">
                      <label className="form-label fw-bold">Zones</label>
                      <p className="mb-0">
                        <span className="badge bg-success">{state.zoneCount || 0} zones</span>
                      </p>
                    </div>
                    {state.workerCount !== undefined && (
                      <div className="mb-3">
                        <label className="form-label fw-bold">Workers</label>
                        <p className="mb-0">
                          <span className="badge bg-primary">{state.workerCount} workers</span>
                        </p>
                      </div>
                    )}
                    {state.guestCount !== undefined && (
                      <div className="mb-3">
                        <label className="form-label fw-bold">Guests</label>
                        <p className="mb-0">
                          <span className="badge bg-warning">{state.guestCount} guests</span>
                        </p>
                      </div>
                    )}
                  </div>

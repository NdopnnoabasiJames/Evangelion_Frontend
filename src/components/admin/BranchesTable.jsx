                ...
                <tr key={branch._id}>
                  ...
                  <td>
                    {branch.branchAdmins && branch.branchAdmins.length > 0 ? (
                      <div>
                        {branch.branchAdmins.map((admin, index) => (
                          <div key={index} className={index > 0 ? 'mt-2 pt-2 border-top' : ''}>
                            <div className="fw-bold"><i className="bi bi-person me-1"></i>{admin.name}</div>
                      ...
                      <div>
                        <div className="fw-bold"><i className="bi bi-person me-1"></i>{branch.branchAdmin.name}</div>
                        <small className="text-muted">{branch.branchAdmin.email}</small>
                      </div>
                    ) : (
                      <span className="text-muted"><i className="bi bi-person-x me-1"></i>No pastor assigned</span>
                    )}
                  </td>
                  <td>

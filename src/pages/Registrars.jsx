          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div>
              <h1 className="h3 mb-0" style={{ color: 'var(--primary-purple)' }}>
                Registrars/PCU/Internship Management
              </h1>
              <p className="text-muted mb-0">Manage registrar, PCU, and INTERNSHIP applications and zone assignments</p>
            </div>
          </div>
  ...
  return (
    <Layout>
      <div className="container-fluid py-4">
        ...
        >
          <TabPane tabId="list" title="All Registrars/PCU/Internship">
            <RegistrarsList 
  ...
  if (!registrars || registrars.length === 0) {
    return (
      <div className="text-center py-5">
        ...
        <p className="text-muted">There are no approved registrars, PCU, or INTERNSHIP members at the moment.</p>
      </div>
    );
  }
  ...
  if (!registrars || registrars.length === 0) {
    return (
      <div className="text-center py-5">
        ...
        <p className="text-muted">All registrar, PCU, INTERNSHIP applications and role-switch requests have been processed.</p>
      </div>
    );
  }
      ...
      {newRegistrarApps.length > 0 && (
        <div>
          <div className="d-flex align-items-center mb-3">
            ...
            <h5 className="mb-0" style={{ color: 'var(--primary-purple)' }}>
              New Registrar/PCU/INTERNSHIP Applications ({newRegistrarApps.length})
            </h5>
          </div>
          <div className="alert alert-primary">
            <i className="bi bi-info-circle me-2"></i>
            These are new registrar, PCU, and INTERNSHIP account applications awaiting approval.
          </div>
          <div className="row g-4">
              ...
              <div key={registrar._id} className="col-md-6 col-lg-4">
                <div className="card h-100 shadow-sm border-0" style={{ borderLeft: '4px solid var(--primary-purple)' }}>
                  <div className="card-body">
                    <div className="d-flex justify-content-between align-items-start mb-3">
                      ...
                      <span className="badge bg-primary">
                        {registrar.role === 'pcu' ? 'New PCU' : 
                         registrar.role === 'intern' ? 'New INTERNSHIP' : 
                         'New Registrar'}
                      </span>
                    </div>
                    ...
                    {/* Only show ApprovalActions for new registrar/PCU/INTERNSHIP applications, not for role switch requests */}
                    {canApprove && (!registrar.requestType || registrar.requestType === 'new_registrar' || registrar.requestType === 'new_pcu' || registrar.requestType === 'new_intern') && (
                      <ApprovalActions

...
const Register = () => {
  ...
  const roleOptions = [
    ...
    { value: 'branch_me', label: 'Branch ME', requiresApproval: 'Branch Pastor' },
    { value: 'zonal_admin', label: 'Zonal Admin', requiresApproval: 'Branch Pastor' },
    { value: 'worker', label: 'Worker', requiresApproval: 'Branch Pastor' },
    { value: 'registrar', label: 'Registrar', requiresApproval: 'Super Admin' },
    { value: 'pcu', label: 'PCU', requiresApproval: 'Branch Pastor' },
    { value: 'intern', label: 'Internship', requiresApproval: 'Branch Pastor' }
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {      const registrationData = {
      ...
      // Show success message with specific approver information
      const roleOption = roleOptions.find(r => r.value === formData.role);
      const approver = roleOption?.requiresApproval || 'an administrator';
      alert(`Registration successful! Your account is pending approval from a ${approver}.`);
      navigate('/login');
      ...
      <div className="container">
        ...
        <footer className="text-center py-3 mt-auto">
          <p className="text-muted small mb-0">
            © 2025 Evangelion. All rights reserved.
          </p>
        </footer>
      </div>
    </div>
